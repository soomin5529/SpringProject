...
<div class="page mypage-modify" id="page">
	...
	<div class="content-body cf">
		<div class="search-group">
			<ul class="lnb-box">
				<li onclick="location.href='<%=request.getContextPath()%>/mypage/mypageModify'" class="on">내 정보 변경</li>
		...
		<div class="content">
			<form action="">
				<table class="tbl tbl-reg">
					<tr>
						<th>아이디</th>
						<td><input type="text" id="id" name="id" value="기존정보 받기" disabled/></td>
					</tr>
					<tr>
						<th>비밀번호</th>
					...
					<tr>
						<th>이름</th>
						<td><input type="text" id="name" name="name" placeholder="이름을 입력하세요" value="정보받아오는 자리"/></td>
					</tr>
					<tr>
						<th>이메일</th>
						<td><input type="email" id="email" name="email" placeholder="이메일을 입력하세요" value="정보받아오는 자리"/></td>
					</tr>
					<tr>
						<th>생일</th>
						<td><input type="date" id="birthdate" name="birthdate" placeholder="생일을 입력하세요" value="정보받아오는 자리"/></td>
					</tr>
					<tr>
						<th>성별</th>
						<td>
