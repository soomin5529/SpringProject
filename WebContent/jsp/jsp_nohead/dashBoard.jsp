...
<div class="map-popup dashboard" id="dashboard">
	...
	<div class="title-box cf">
		<div class="back-btn" onclick="$('#dash-board').empty();">
		...
		<!-- bookmark on/off -->
	<c:if test="${checkAreaLike != null && checkAreaLike == true }">
		<div class="bookmark on" id="bookmark" onclick="javascript:changeBookmark()">
	</c:if>
	<c:if test="${checkAreaLike == null || checkAreaLike == false }">
		<div class="bookmark off" id="bookmark" onclick="javascript:changeBookmark()">
	</c:if>
	...
	<div class="search-box">
		...
		<div class="input-box third">
			...
			<select id="small" name="small_category"
				onchange="javascript:dashBoardSetSession(this, ${dong.code }); findStoreInDongBound(mapBound(), ${dong.code }, this.id, this.value);">
...
<div class="map-popup community" value="${dong.code }" id="community" style="display:none;"></div>