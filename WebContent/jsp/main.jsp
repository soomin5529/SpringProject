...
<div class="page main" id="page">
		...
		<div class="search-box">
			<div class="input-box">
				...
				<select id="sido" name="state"
					...
					<option value="no" disabled selected>선택</option>
				</select> <select id="dong" name="street" onchange="findAreaToJson(this);">
					<option value="no" disabled selected>선택</option>
				</select>
			</div>
		</div>
	...
	<div class="map-popup community" id="community" style="display: none">
		<div class="title-box cf">
			...
			<div class="tit">
				<span>떠들썩</span> <span class="highlight01" id="postCount">10</span>
			</div>
		...
		<div class="list-box">
			...
			<div class="post-box">
				<div class="content-box cf">
					...
					<div class="content">
						<div class="text">코로나 여파가 있어도 장사는 잘되더군요,, 직장인분들이 많다보니 매출손해가
							크지 않아요 체인점 내실 분 쪽지 주십쇼.</div>
						<div class="photo"
							style="background-image: url('../images/gogi.jpg');"></div>
					</div>
	...
	<div class="pop-container" id="communityReg">
		...
		<div class="pop-box" style="width: 400px; height: 570px;">
			...
			<div class="content-box">
				<!-- 이름 -->
				<input type="text" value="역삼 뽀시래기" placeholder="닉네임을 입력하세요"
					style="margin-bottom: 10px;">
				<!-- 내용입력 -->
				<textarea name="communityContent" rows=14
