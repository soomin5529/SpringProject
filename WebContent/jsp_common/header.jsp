...
<body>
	...
	<div class="header">
		...
		<!-- user menu -->
		<ul class="user-menu">
			<li onclick="openPopMyPage()"><img
				src="<%=request.getContextPath()%>/images/ic_bell.png" alt="push" /></li>
			<li onclick="openPopMyPage()"><img
				src="<%=request.getContextPath()%>/images/ic_user.png" alt="user" /></li>
		</ul>
	</div>
