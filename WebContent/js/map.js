...
window.onload = function() {
   ...
   function selectCity() {
    ...
    if(selected_city == "Gangnamgu") selected_city = Gangnamgu;
    if(selected_city == "Dobonggu") selected_city = Dobonggu;
    if(selected_city == "Eunpyeonggu") selected_city = Eunpyeonggu;
    if(selected_city == "Dongdaemungu") selected_city = Dongdaemungu;
    if(selected_city == "Dongjakgu") selected_city = Dongjakgu;
    if(selected_city == "Geumcheongu") selected_city = Geumcheongu;
    if(selected_city == "Gurogu") selected_city = Gurogu;
    if(selected_city == "Jongnogu") selected_city = Jongnogu;
    if(selected_city == "Gangbukgu") selected_city = Gangbukgu;
    if(selected_city == "Jungnanggu") selected_city = Jungnanggu;
    if(selected_city == "Gangseogu") selected_city = Gangseogu;
    if(selected_city == "Junggu") selected_city = Junggu;
    if(selected_city == "Gangdonggu") selected_city = Gangdonggu;
    if(selected_city == "Gwangjingu") selected_city = Gwangjingu;
    if(selected_city == "Mapogu") selected_city = Mapogu;
    if(selected_city == "Seochogu") selected_city = Seochogu;
    if(selected_city == "Seongbukgu") selected_city = Seongbukgu;
    if(selected_city == "Nowongu") selected_city = Nowongu;
    if(selected_city == "Songpagu") selected_city = Songpagu;
    if(selected_city == "Seodaemungu") selected_city = Seodaemungu;
    if(selected_city == "Yangcheongu") selected_city = Yangcheongu;
    if(selected_city == "Yeongdeungpogu") selected_city = Yeongdeungpogu;
    if(selected_city == "Gwanakgu") selected_city = Gwanakgu;
